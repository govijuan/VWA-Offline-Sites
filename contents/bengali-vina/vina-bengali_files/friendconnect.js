...
var friendconnect_serverVersion = "0.1-a68243ad_a84f2277_d3c398ae_5e4d33c5_1e5a1d82.7";
...
fcra="Dialog",fcG="style",fcH="body",fcI="call",fcJ="options",fcsa="json",fcta="charCodeAt",fcua="href",fcva="substring",fcwa="getContentElement",fcK="util",fcxa="maxHeight",fcL="apply",fcya="reset",fcM="update",fcN="height",fcO="join",fcza="toLowerCase",fcAa="right",goog=goog||{},fcP=this,fcBa=function(a,b,c){a=a[fcD](".");c=c||fcP;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a[fcB]&&(d=a[fcha]());)a[fcB]||void 0===b?c=c[d]?c[d]:c[d]={}:c[d]=b},fcCa=function(a){var b=typeof a;if("object"==
b)if(a){if(a instanceof fcf)return"array";if(a instanceof fcaa)return b;var c=fcaa[fc][fcpa][fcI](a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a[fcB]&&"undefined"!=typeof a.splice&&"undefined"!=typeof a[fcqa]&&!a[fcqa]("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a[fcI]&&"undefined"!=typeof a[fcqa]&&!a[fcqa]("call"))return"function"}else return"null";else if("function"==b&&"undefined"==typeof a[fcI])return"object";return b},fcDa=function(a){return void 0!==
a},fcEa=function(a){var b=fcCa(a);return"array"==b||"object"==b&&"number"==typeof a[fcB]},fcQ=function(a){return"string"==typeof a},fcFa=function(a){var b=typeof a;return"object"==b&&null!=a||"function"==b},fcR=function(a){var b=fcCa(a);if("object"==b||"array"==b){if(a.clone)return a.clone();var b="array"==b?[]:{},c;for(c in a)b[c]=fcR(a[c]);return b}return a},fcGa=function(a,b,c){return a[fcI][fcL](a[fcoa],arguments)},fcHa=function(a,b,c){if(!a)throw fch();if(2<arguments[fcB]){var d=fcf[fc][fcq][fcI](arguments,
...
fcY[fc].update=function(a,b){fcDa(b)||(b=a[fcB]);for(var c=b-this.blockSize,d=0,e=this.Ca,f=this.G;d<b;){if(0==f)for(;d<=c;)this.L(a,d),d+=this.blockSize;if(fcQ(a))for(;d<b;){if(e[f]=a[fcta](d),++f,++d,f==this.blockSize){this.L(e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.blockSize){this.L(e);f=0;break}}this.G=f;this.ya+=b};
...
fcZ[fc].set=function(a,b,c,d,e,f){if(!this.Vb(a))throw fch('Invalid cookie name "'+a+'"');if(!this.Wb(b))throw fch('Invalid cookie value "'+b+'"');fcDa(c)||(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";f=f?";secure":"";0>c?c="":(c=0==c?new Date(1970,1,1):new Date(fcKa()+1E3*c),c=";expires="+c.toUTCString());this.wc(a+"="+b+e+d+c+f)};fcZ[fc].get=function(a,b){for(var c=a+"=",d=this.ja(),e=0,f;f=d[e];e++){if(0==f.lastIndexOf(c,0))return f.substr(c[fcB]);if(f==a)return""}return b};
fcZ[fc].remove=function(a,b,c){var d=this.M(a);this.set(a,"",0,b,c);return d};fcZ[fc].r=function(){return this.ha().keys};fcZ[fc].F=function(){return this.ha().values};fcZ[fc].P=function(){var a=this.Na();return a?this.ja()[fcB]:0};fcZ[fc].M=function(a){return fcDa(this.get(a))};fcZ[fc].clear=function(){for(var a=this.ha().keys,b=a[fcB]-1;0<=b;b--)this.remove(a[b])};fcZ[fc].wc=function(a){this.xb.cookie=a};fcZ[fc].Na=function(){return this.xb.cookie};fcZ[fc].ja=function(){return(this.Na()||"")[fcD](fcvb)};
...
google.friendconnect.container.setServerBase('http://www-a-fc-opensocial.googleusercontent.com/ps/');google.friendconnect.container.setServerVersion('0.1-a68243ad_a84f2277_d3c398ae_5e4d33c5_1e5a1d82.7');google.friendconnect.container.setApiVersion('0.8');
...
google.friendconnect.container.setDateStamp_('1454176821a');